    ...
    <div className="flex flex-col gap-3 rounded-lg border border-border bg-card p-4">
      <div className="flex items-center justify-between">
        <p className="text-xs font-medium uppercase tracking-wide text-muted-foreground">
          Edit <span className="font-mono normal-case text-foreground">{env.name}</span>
        </p>
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor="env-description" className="text-xs text-muted-foreground">
          Description
        </label>
        <input
          id="env-description"
      ...
      <div className="flex items-center justify-end gap-2">
        ...
        <Button size="sm" onClick={() => void onSave()} disabled={saving || !dirty || !!duplicateKey}>
          Save changes
        </Button>
      </div>
    </div>
