...
function Menubar({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="menubar"
      className={cn(
        "flex h-8 items-center gap-0.5 rounded-md p-0.5 select-none",
        className
      )}
      {...props}
    />
...
function MenubarTrigger({
  ...
  return (
    <MenuPrimitive.Trigger
      ...
      className={cn(
        "flex items-center gap-1.5 rounded-sm px-2 py-1 text-xs font-medium outline-hidden select-none hover:bg-muted focus:bg-muted focus:text-foreground data-popup-open:bg-muted data-popup-open:text-foreground",
        className
      )}
      {...props}
    />
...
function MenubarShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto text-[10px] font-mono tracking-widest text-muted-foreground group-focus/menubar-item:text-accent-foreground",
        className
      )}
      {...props}
    />
