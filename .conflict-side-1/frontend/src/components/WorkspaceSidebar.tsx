				...
				<span className="flex items-center gap-0.5">
					...
					{workspaceTree && (
						<HoverCard>
							<HoverCardTrigger
								render={
									<Button variant="ghost" size="icon-xs" onClick={() => setImportOpen(true)} aria-label="Import into workspace" />
								}
							>
								<SquareArrowOutDownLeft className="size-3.5" aria-hidden />
							</HoverCardTrigger>
							<HoverCardContent className="w-auto max-w-56 text-xs">
								Import from cURL, OpenAPI, HAR, Postman, Insomnia, or Bruno
							</HoverCardContent>
						</HoverCard>
					)}
					{workspaceTree && (
						<HoverCard>
							<HoverCardTrigger
								render={
									<Button variant="ghost" size="icon-xs" onClick={() => setExportOpen(true)} aria-label="Export workspace" />
								}
							>
								<FileDown className="size-3.5" aria-hidden />
							</HoverCardTrigger>
							<HoverCardContent className="w-auto max-w-56 text-xs">
								Export as Postman, OpenAPI, HAR, or a workspace copy
							</HoverCardContent>
						</HoverCard>
					)}
					{workspaceTree && (
