...
- [ ] Spec: this milestone (P3 `Milestones/05` §58 + M67-M75) vs implementation (`ROADMAP.md` Phase 4 + DoD: core+UI/CLI+tests) — `git log main..HEAD` + `git diff main...HEAD` — both axes must be green before ticking `[x]` above; fix `main...HEAD` diff until green — run `/code-review`
