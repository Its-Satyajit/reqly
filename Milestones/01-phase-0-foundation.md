...
- [x] Spec: this milestone (`Milestones/01`) vs implementation (`ROADMAP.md` Phase 0 + DoD: core+UI/CLI+tests) — `git log main..HEAD` + `git diff main...HEAD` — both axes must be green before ticking `[x]` above; fix `main...HEAD` diff until green — run `/code-review`
