...
- [x] Spec: this milestone (P1 `Milestones/03` §56 + M28-M37) vs implementation (`ROADMAP.md` Phase 2 + DoD: core+UI/CLI+tests) — `git log main..HEAD` + `git diff main...HEAD` — both axes must be green before ticking `[x]` above; fix `main...HEAD` diff until green — run `/code-review`
