...
24. **Code generation** — [Spec #211](https://github.com/Its-Satyajit/reqly/issues/211), tickets [#212–#215](https://github.com/Its-Satyajit/reqly/issues/212): `internal/exporter.Generate` (cURL/JS/Python/Go, `reqly export code` + `Copy as`) ([ADR 0016](docs/adr/0016-code-generation.md)) — *in progress (T1 landed `internal/exporter/code.go` golden files)*
